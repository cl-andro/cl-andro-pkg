...
CLANDRO_PKG_HOMEPAGE=https://www.opencontainers.org/
CLANDRO_PKG_DESCRIPTION="A tool for spawning and running containers according to the OCI specification"
CLANDRO_PKG_LICENSE="Apache-2.0"
CLANDRO_PKG_MAINTAINER="@clandro"
CLANDRO_PKG_VERSION="1.4.0"
CLANDRO_PKG_SRCURL="https://github.com/opencontainers/runc/archive/refs/tags/v${CLANDRO_PKG_VERSION}.tar.gz"
CLANDRO_PKG_SHA256=94d566d8b017d6cdffc684560a4f069bb87f86534976c41d768711c85e194884
CLANDRO_PKG_AUTO_UPDATE=true
CLANDRO_PKG_BUILD_DEPENDS="libseccomp-static"

clandro_step_make() {
	${CC} -c -o stubs.o "$CLANDRO_PKG_BUILDER_DIR/stubs.c"
	${AR} rcs liblog.a stubs.o

	export CGO_LDFLAGS="-L$CLANDRO_PKG_BUILDDIR"
	...
	ln -sf "${CLANDRO_PKG_SRCDIR}" "${GOPATH}/src/github.com/opencontainers/runc"
...
clandro_step_make_install() {
	...
	install -Dm755 runc "${CLANDRO_PREFIX}/bin/runc"
}

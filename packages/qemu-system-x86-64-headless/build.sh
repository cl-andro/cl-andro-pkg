...
CLANDRO_PKG_DESCRIPTION="A generic and open source machine emulator and virtualizer (headless)"
...
CLANDRO_PKG_DEPENDS="alsa-lib, dtc, glib, jack2, libbz2, libcurl, libdw, libgmp, libgnutls, libiconv, libjpeg-turbo, liblzo, libnettle, libnfs, libpixman, libpng, libslirp, libspice-server, libssh, libusb, libusbredir, ncurses, pulseaudio, qemu-common, resolv-conf, zlib, zstd"

# Required by configuration script, but I can't find any binary that uses it.
CLANDRO_PKG_BUILD_DEPENDS="libtasn1"

CLANDRO_PKG_CONFLICTS="qemu-system-x86_64-headless"
CLANDRO_PKG_REPLACES="qemu-system-x86_64-headless"
CLANDRO_PKG_PROVIDES="qemu-system-x86_64-headless"

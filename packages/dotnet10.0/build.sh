...
CLANDRO_PKG_DESCRIPTION=".NET 10.0"
CLANDRO_PKG_LICENSE="MIT"
CLANDRO_PKG_MAINTAINER="@truboxl"
CLANDRO_PKG_VERSION="10.0.7"
...
CLANDRO_PKG_SUGGESTS="dotnet-sdk-10.0"
CLANDRO_PKG_CONFLICTS="dotnet8.0, dotnet9.0"
...
clandro_step_pre_configure() {
	...
	CLANDRO_PKG_DEPENDS="aspnetcore-runtime-10.0, dotnet-host, dotnet-runtime-10.0"
...
clandro_step_make_install() {
	...
	#find "${CLANDRO_PKG_BUILDDIR}/artifacts/assets" -type f \( -name "*.tar.gz" -o -name "*.zip" \) -exec cp -fv "{}" "${CLANDRO_PREFIX}/opt/${CLANDRO_PKG_NAME}" \;

	# extract tarball
	tar -xf "${CLANDRO_PKG_BUILDDIR}/artifacts/assets/${CONFIG}"/dotnet-sdk-*.tar.gz -C "${_DOTNET_ROOT}"
	tar -xf "${CLANDRO_PKG_BUILDDIR}/artifacts/assets/${CONFIG}"/dotnet-symbols-sdk-*.tar.gz -C "${_DOTNET_ROOT}"

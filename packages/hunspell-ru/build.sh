...
CLANDRO_PKG_DESCRIPTION="Russian dictionary for hunspell"
CLANDRO_PKG_LICENSE="LGPL-3.0"
CLANDRO_PKG_MAINTAINER="@clandro"
CLANDRO_PKG_VERSION=20210731
...
clandro_step_make_install() {
	...
	clandro_download https://cgit.freedesktop.org/libreoffice/dictionaries/plain/ru_RU/ru_RU.aff \
			$CLANDRO_PREFIX/share/hunspell/ru_RU.aff \
			38ce7d4af78e211e9bafe4bf7e3d6a2c420591136cb738ec6648f8fdf6524cd7
	clandro_download https://cgit.freedesktop.org/libreoffice/dictionaries/plain/ru_RU/ru_RU.dic \
			$CLANDRO_PREFIX/share/hunspell/ru_RU.dic \
			f6047416a0204adbecf3a451b874ec8a97ee37e2cbc714466ef04d8dbcc0d6fc
	touch $CLANDRO_PREFIX/share/hunspell/ru_RU.{aff,dic}
}

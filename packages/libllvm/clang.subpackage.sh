...
share/scan-*
"
CLANDRO_SUBPKG_DESCRIPTION="C language frontend for LLVM"
CLANDRO_SUBPKG_DEPENDS="libcompiler-rt, lld, llvm, ndk-sysroot"
CLANDRO_SUBPKG_BREAKS="libllvm (<< 16.0.0), clangd"
CLANDRO_SUBPKG_REPLACES="libllvm (<< 16.0.0), clangd"
CLANDRO_SUBPKG_GROUPS="base-devel"

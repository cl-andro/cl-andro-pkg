...
CLANDRO_PKG_SHA256=25da1c97d7a01bc4cee34121c32909872edd38404589c0427fefa1301743f18f
CLANDRO_PKG_SRCURL=https://github.com/Unidata/netcdf-cxx4/archive/v${CLANDRO_PKG_VERSION}.tar.gz
CLANDRO_PKG_DEPENDS="libhdf5, libcurl, openssl, libnghttp2, netcdf-c"

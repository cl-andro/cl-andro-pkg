CLANDRO_PKG_HOMEPAGE=https://www.haskell.org/ghc/
CLANDRO_PKG_DESCRIPTION="The Glasgow Haskell Compiler"
CLANDRO_PKG_LICENSE="custom"
CLANDRO_PKG_MAINTAINER="Aditya Alok <alok@termux.dev> & @clandro"
CLANDRO_PKG_VERSION=9.12.2
CLANDRO_PKG_REVISION=2
CLANDRO_PKG_SRCURL="https://downloads.haskell.org/~ghc/$CLANDRO_PKG_VERSION/ghc-$CLANDRO_PKG_VERSION-src.tar.xz"
CLANDRO_PKG_SHA256=0e49cd5dde43f348c5716e5de9a5d7a0f8d68d945dc41cf75dfdefe65084f933
CLANDRO_PKG_DEPENDS="libiconv, libffi, libgmp, libandroid-posix-semaphore, ncurses"
CLANDRO_PKG_BUILD_IN_SRC=true
CLANDRO_PKG_EXTRA_CONFIGURE_ARGS="
--host=$CLANDRO_BUILD_TUPLE
--with-system-libffi
--disable-ld-override"
CLANDRO_PKG_NO_STATICSPLIT=true
CLANDRO_PKG_LICENSE_FILE="LICENSE"
CLANDRO_PKG_REPLACES="ghc-libs-static, ghc-libs"
CLANDRO_PKG_PROVIDES="ghc-libs, ghc-libs-static"

__setup_bootstrap_compiler() {
	local version=9.10.1
	local temp_folder="$CLANDRO_PKG_CACHEDIR/ghc-bootstrap-$version"
	...
	clandro_download "https://downloads.haskell.org/~ghc/$version/ghc-$version-x86_64-ubuntu20_04-linux.tar.xz" \
		"$tarball" \
...
clandro_step_pre_configure() {
	...
	CLANDRO_PKG_EXTRA_CONFIGURE_ARGS="$CLANDRO_PKG_EXTRA_CONFIGURE_ARGS --target=$target"
	./boot.source
}
...
clandro_step_make_install() {
	cd _build/bindist/ghc-"$CLANDRO_PKG_VERSION"-"$target" || exit 1
...
clandro_step_post_massage() {
	local ghclibs_dir="lib/ghc-$CLANDRO_PKG_VERSION"

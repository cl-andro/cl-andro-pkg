...
CLANDRO_PKG_DESCRIPTION="Chromium based browser built to run in a terminal"
...
CLANDRO_PKG_BUILD_DEPENDS="carbonyl-host-tools, libnotify, libffi-static"
...
clandro_step_post_get_source() {
	local _host_builder_dir="${CLANDRO_SCRIPTDIR}/x11-packages/carbonyl-host-tools"
...
clandro_step_make_install() {
	...
	clandro_setup_rust
	cp $CLANDRO_PKG_SRCDIR/build/$CARGO_TARGET_NAME/release/*.so $CLANDRO_PREFIX/lib/$CLANDRO_PKG_NAME/
	...
	cp "${normal_files[@]/#/out/Release/}" "$CLANDRO_PREFIX/lib/$CLANDRO_PKG_NAME/"

	cp -Rf out/Release/angledata $CLANDRO_PREFIX/lib/$CLANDRO_PKG_NAME/

	chmod +x $CLANDRO_PREFIX/lib/$CLANDRO_PKG_NAME/headless_shell

	# Install as the default binary
	ln -sfr $CLANDRO_PREFIX/lib/$CLANDRO_PKG_NAME/headless_shell $CLANDRO_PREFIX/bin/carbonyl
}

...
CLANDRO_PKG_VERSION=6.0
CLANDRO_PKG_REVISION=10
CLANDRO_PKG_SRCURL=https://downloads.sourceforge.net/infozip/unzip60.tar.gz
CLANDRO_PKG_SHA256=036d96991646d0449ed0aa952e4fbe21b476ce994abc276e49d30e686708bd37
...
clandro_step_make() {
	...
	make -f unix/Makefile prefix=$CLANDRO_PREFIX D_USE_BZ2=-DUSE_BZIP2 \
		L_BZ2=-lbz2 LF2="$LDFLAGS" CC="$CC" CF="$CFLAGS" LD="$CC" unzips
}

clandro_step_make_install() {
	make -f unix/Makefile prefix=$CLANDRO_PREFIX install
}

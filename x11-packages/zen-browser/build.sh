CLANDRO_PKG_HOMEPAGE=https://zen-browser.app
CLANDRO_PKG_DESCRIPTION="Zen is a firefox-based browser with the aim of pushing your productivity to a new level!"
CLANDRO_PKG_LICENSE="MPL-2.0"
CLANDRO_PKG_MAINTAINER="@sabamdarif"
CLANDRO_PKG_VERSION="1.19.12b"
CLANDRO_PKG_SRCURL="https://github.com/zen-browser/desktop/releases/download/${CLANDRO_PKG_VERSION}/zen.source.tar.zst"
CLANDRO_PKG_SHA256=c18cfced452f4e4edf4c47872f086297d29f40ca0f6f5bc01e3f32d2e730432a
# ffmpeg and pulseaudio are dependencies through dlopen(3):
CLANDRO_PKG_DEPENDS="ffmpeg, fontconfig, freetype, gdk-pixbuf, glib, gtk3, libandroid-shmem, libandroid-spawn, libc++, libcairo, libevent, libffi, libice, libicu, libjpeg-turbo, libnspr, libnss, libpixman, libsm, libvpx, libwebp, libx11, libxcb, libxcomposite, libxdamage, libxext, libxfixes, libxrandr, libxtst, pango, pulseaudio, zlib"
...
clandro_step_configure() {
	...
	sed \
		...
		-e "s|@CLANDRO_PKG_VERSION@|${CLANDRO_PKG_VERSION}|" \
...
clandro_step_make_install() {
	...
	sed "s|@CLANDRO_PKG_NAME@|${CLANDRO_PKG_NAME}|g" \
		"${CLANDRO_PKG_BUILDER_DIR}/${CLANDRO_PKG_NAME}.desktop.in" >"${CLANDRO_PKG_NAME}.desktop"
	install -Dm644 "${CLANDRO_PKG_NAME}.desktop" "${CLANDRO_PREFIX}/share/applications/${CLANDRO_PKG_NAME}.desktop"
	...
	for i in 16 32 48 64 128; do
		...
		install -Dvm644 "browser/branding/$theme/default$i.png" \
			"$CLANDRO_PREFIX/lib/$CLANDRO_PKG_NAME/browser/chrome/icons/default/default$i.png"
	done
...
clandro_step_post_make_install() {
	local r=$("${READELF}" -d "${CLANDRO_PREFIX}/bin/${CLANDRO_PKG_NAME}")

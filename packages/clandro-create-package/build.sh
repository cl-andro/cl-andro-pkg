CLANDRO_PKG_HOMEPAGE=https://github.com/termux/clandro-create-package
CLANDRO_PKG_DESCRIPTION="Utility to create Termux packages"
CLANDRO_PKG_LICENSE="Apache-2.0"
CLANDRO_PKG_MAINTAINER="@clandro"
CLANDRO_PKG_VERSION="0.12.0"
CLANDRO_PKG_REVISION=3
CLANDRO_PKG_SRCURL="https://github.com/termux/clandro-create-package/archive/refs/tags/v${CLANDRO_PKG_VERSION}.tar.gz"

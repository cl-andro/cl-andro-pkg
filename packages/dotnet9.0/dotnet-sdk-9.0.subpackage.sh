CLANDRO_SUBPKG_DESCRIPTION=".NET 9.0 SDK"
CLANDRO_SUBPKG_DEPEND_ON_PARENT=false
CLANDRO_SUBPKG_DEPENDS="aspnetcore-runtime-9.0, aspnetcore-targeting-pack-9.0, dotnet-apphost-pack-9.0, dotnet-runtime-9.0, dotnet-targeting-pack-9.0, dotnet-templates-9.0, netstandard-targeting-pack-2.1"

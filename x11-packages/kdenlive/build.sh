CLANDRO_PKG_HOMEPAGE='https://apps.kde.org/kdenlive/'
CLANDRO_PKG_DESCRIPTION='A non-linear video editor for Linux using the MLT video framework'
CLANDRO_PKG_LICENSE="GPL-2.0"
CLANDRO_PKG_MAINTAINER="@clandro"
CLANDRO_PKG_VERSION="26.04.1"
CLANDRO_PKG_SRCURL=https://download.kde.org/stable/release-service/${CLANDRO_PKG_VERSION}/src/kdenlive-${CLANDRO_PKG_VERSION}.tar.xz
CLANDRO_PKG_SHA256=fd515a827f66f5e2c8d60272001e993fb96ebccf7c7d21f78adb16ff210530ac
CLANDRO_PKG_DEPENDS="libc++, ffplay, frei0r-plugins, kddockwidgets, kf6-karchive, kf6-kbookmarks, kf6-kcodecs, kf6-kcolorscheme, kf6-kcompletion, kf6-kconfig, kf6-kconfigwidgets, kf6-kcoreaddons, kf6-kdbusaddons, kf6-kfilemetadata, kf6-kguiaddons, kf6-ki18n, kf6-kiconthemes, kf6-kio, kf6-kitemviews, kf6-knewstuff, kf6-knotifications, kf6-knotifyconfig, kf6-ktextwidgets, kf6-kwidgetsaddons, kf6-kxmlgui, kf6-purpose, kf6-qqc2-desktop-style, kf6-solid, mediainfo, mlt, opentimelineio, qt6-qtbase, qt6-qtdeclarative, qt6-qtmultimedia, qt6-qtnetworkauth, qt6-qtsvg, shared-mime-info"
CLANDRO_PKG_BUILD_DEPENDS="extra-cmake-modules, imath, qt6-qttools, kf6-kconfig-cross-tools"

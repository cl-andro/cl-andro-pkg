CLANDRO_PKG_HOMEPAGE=https://github.com/awesomeWM/awesome
CLANDRO_PKG_DESCRIPTION="A highly configurable, next generation framework window manager for X (built with luajit)"
CLANDRO_PKG_LICENSE="GPL-2.0"
CLANDRO_PKG_MAINTAINER="@clandro"
_COMMIT=fa805ab465821c54094126b71a92acf2eba17674
CLANDRO_PKG_VERSION="2026.03.31"
CLANDRO_PKG_SRCURL=git+https://github.com/awesomeWM/awesome
CLANDRO_PKG_SHA256=ed61955ed9bdf1d216b881543572c32c83a15f419d9410d5c6b4ed3df3392383
CLANDRO_PKG_GIT_BRANCH=master
CLANDRO_PKG_DEPENDS="dbus, gdk-pixbuf, glib, libcairo, luajit, libx11, libxcb, libxdg-basedir, libxkbcommon, luajit-lgi, pango, startup-notification, xcb-util, xcb-util-cursor, xcb-util-keysyms, xcb-util-wm, xcb-util-xrm"
CLANDRO_PKG_BUILD_DEPENDS="imagemagick"
CLANDRO_PKG_BREAKS="awesome"
CLANDRO_PKG_CONFLICTS="awesome"
CLANDRO_PKG_EXTRA_CONFIGURE_ARGS="
-DLUA_MATH_LIBRARY=
-DCMAKE_POLICY_VERSION_MINIMUM=3.5
-DLUA_INCLUDE_DIR=$CLANDRO_PREFIX/include/luajit-2.1
-DLUA_LIBRARY=$CLANDRO_PREFIX/lib/libluajit-5.1.so
"
...
clandro_step_post_get_source() {
	...
	find "$CLANDRO_PKG_SRCDIR" -type f -print0 | \
		xargs -0 sed -i \
...
_load_ubuntu_packages() {
	...
	export LUA_PATH="${HOSTBUILD_ROOTFS}/usr/share/lua/$hostbuild_luajit_version/?.lua;${CLANDRO_PKG_SRCDIR}/?.lua"
...
clandro_step_host_build() {
	...
	local HOSTBUILD_ROOTFS="${CLANDRO_PKG_HOSTBUILD_DIR}/ubuntu_packages"
	...
	LUAJIT_LGI="$CLANDRO_PKG_HOSTBUILD_DIR/luajit-lgi"
	(. "$CLANDRO_SCRIPTDIR/packages/luajit-lgi/build.sh"; CLANDRO_PKG_SRCDIR="$LUAJIT_LGI" clandro_step_get_source)
	$CLANDRO_MESON setup \
		"$LUAJIT_LGI" \
		"$LUAJIT_LGI/build" \
		...
		-Dlua-pc=luajit \
		-Dlua-bin=luajit
	$CLANDRO_MESON compile -C "$LUAJIT_LGI/build"
	$CLANDRO_MESON install -C "$LUAJIT_LGI/build"
...
clandro_step_pre_configure() {
	...
	CLANDRO_PKG_EXTRA_CONFIGURE_ARGS+=" -DLUA_EXECUTABLE=$(command -v luajit)"
}

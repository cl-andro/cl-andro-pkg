CLANDRO_SUBPKG_DESCRIPTION="Swift runtime libraries for Android x86_64"
CLANDRO_SUBPKG_INCLUDE="opt/ndk-multilib/x86_64-linux-android/lib/lib[_FTXs]*.so"
...
clandro_step_create_subpkg_debscripts() {
	...
	sed 's|@COMMAND@|ln -sf "'$CLANDRO_PREFIX'/opt/ndk-multilib/x86_64-linux-android/lib/lib$so.so" "$install_path"|' \

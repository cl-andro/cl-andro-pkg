CLANDRO_PKG_HOMEPAGE=https://github.com/libpinyin/libpinyin
CLANDRO_PKG_DESCRIPTION="Library to deal with pinyin."
CLANDRO_PKG_LICENSE="GPL-3.0"
CLANDRO_PKG_MAINTAINER="@clandro"
CLANDRO_PKG_VERSION=2.10.3
CLANDRO_PKG_SRCURL=https://github.com/libpinyin/libpinyin/releases/download/$CLANDRO_PKG_VERSION/libpinyin-$CLANDRO_PKG_VERSION.tar.gz
CLANDRO_PKG_SHA256=3fe786ff2c2059bdbdf9d8d752db691a516a941a977521955fe0af3f0b4db299
CLANDRO_PKG_BUILD_IN_SRC=true
CLANDRO_PKG_DEPENDS="glib, libdb"
...
clandro_step_host_build() {
	...
	clandro_download_ubuntu_packages libdb-dev libdb5.3-dev
	...
	"$CLANDRO_PKG_SRCDIR/configure" --prefix="${HOSTBUILD_ROOTFS}/usr"
...
clandro_step_pre_configure() {
	...
	if [[ "$CLANDRO_ON_DEVICE_BUILD" == "false" ]]; then
		_load_ubuntu_packages
		local patch="$CLANDRO_PKG_BUILDER_DIR/use-hostbuilt-binaries.diff"

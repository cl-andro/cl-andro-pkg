CLANDRO_PKG_HOMEPAGE=https://github.com/termux/clandro-auth
CLANDRO_PKG_DESCRIPTION="Password authentication library and utility for Termux"
CLANDRO_PKG_LICENSE="GPL-3.0"
CLANDRO_PKG_MAINTAINER="@clandro"
CLANDRO_PKG_VERSION=1.5.0
CLANDRO_PKG_REVISION=1
CLANDRO_PKG_SRCURL=https://github.com/termux/clandro-auth/archive/refs/tags/v${CLANDRO_PKG_VERSION}.tar.gz
...
clandro_step_pre_configure() {
	CPPFLAGS+=" -DTERMUX_HOME=\\\"${CLANDRO_ANDROID_HOME}\\\" -DTERMUX_PREFIX=\\\"${CLANDRO_PREFIX}\\\""
}

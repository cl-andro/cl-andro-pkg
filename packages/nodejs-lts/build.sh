...
# Also update version in clandro_setup_nodejs.sh when updating this package
CLANDRO_PKG_VERSION=24.14.1
CLANDRO_PKG_SRCURL=https://nodejs.org/dist/v${CLANDRO_PKG_VERSION}/node-v${CLANDRO_PKG_VERSION}.tar.xz
CLANDRO_PKG_SHA256=7822507713f202cf2a551899d250259643f477b671706db421a6fb55c4aa0991
...
CLANDRO_PKG_CONFLICTS="nodejs, nodejs-current"

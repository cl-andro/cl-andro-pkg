CLANDRO_PKG_HOMEPAGE=https://swi-prolog.org/
CLANDRO_PKG_DESCRIPTION="Most popular and complete prolog implementation"
CLANDRO_PKG_LICENSE="BSD 2-Clause"
CLANDRO_PKG_MAINTAINER="@clandro"
CLANDRO_PKG_VERSION="10.1.6"
CLANDRO_PKG_SRCURL=https://www.swi-prolog.org/download/devel/src/swipl-${CLANDRO_PKG_VERSION}.tar.gz
CLANDRO_PKG_SHA256=b669e6b6b83bffde209932d5e8f151be7a8cf7ec0963898c7a2a18b7fa598be2
CLANDRO_PKG_DEPENDS="libandroid-execinfo, libarchive, libcrypt, libdb, libedit, libgmp, libyaml, ncurses, openssl, ossp-uuid, pcre2, python, unixodbc, zlib"
...
-DSWIPL_NATIVE_FRIEND=${CLANDRO_PKG_HOSTBUILD_DIR}
-DPOSIX_SHELL=${CLANDRO_PREFIX}/bin/sh
-DSWIPL_TMP_DIR=${CLANDRO_PREFIX}/tmp
-DSYSTEM_CACERT_FILENAME=${CLANDRO_PREFIX}/etc/tls/cert.pem
-DODBC_CONFIG=
"
...
clandro_step_pre_configure() {
	CLANDRO_PKG_EXTRA_CONFIGURE_ARGS+=" $_SHARED_EXTRA_CONFIGURE_ARGS"

...
"
CLANDRO_SUBPKG_DESCRIPTION="Portion of openjdk-25 requiring X11 functionality"
CLANDRO_SUBPKG_DEPENDS="freetype, giflib, libandroid-shmem, libjpeg-turbo, libpng, libx11, libxext, libxi, libxrender, libxtst"

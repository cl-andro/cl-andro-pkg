...
CLANDRO_PKG_DEPENDS="gdk-pixbuf, glib, gtk3, libcairo, libcanberra, libice, libiconv, libsm, libsodium, libx11, libxt, ncurses, pango"
CLANDRO_PKG_SUGGESTS="luajit, perl, python, ruby, tcl"
CLANDRO_PKG_RECOMMENDS="diffutils, xxd"
CLANDRO_PKG_CONFLICTS="vim"
CLANDRO_PKG_BREAKS="vim-python"
CLANDRO_PKG_REPLACES="vim-python"

CLANDRO_PKG_HOMEPAGE=https://www.mpfr.org/
CLANDRO_PKG_DESCRIPTION="C library for multiple-precision floating-point computations with correct rounding"
CLANDRO_PKG_LICENSE="LGPL-3.0"
CLANDRO_PKG_MAINTAINER="@clandro"
CLANDRO_PKG_VERSION=4.2.1
CLANDRO_PKG_REVISION=1
_MAIN_VERSION=${CLANDRO_PKG_VERSION%-p*}
CLANDRO_PKG_SRCURL=https://mirrors.kernel.org/gnu/mpfr/mpfr-${_MAIN_VERSION}.tar.xz
CLANDRO_PKG_SHA256=277807353a6726978996945af13e52829e3abd7a9a5b7fb2793894e18f1fcbb2
CLANDRO_PKG_AUTO_UPDATE=false
CLANDRO_PKG_DEPENDS="libgmp"
CLANDRO_PKG_BREAKS="libmpfr-dev"
CLANDRO_PKG_REPLACES="libmpfr-dev"
CLANDRO_PKG_EXTRA_CONFIGURE_ARGS="ac_cv_header_locale_h=no"

clandro_step_post_get_source() {
	if ! [[ $CLANDRO_PKG_VERSION = *-p* ]]; then
		return 0
	fi
	local _PATCH_VERSION=${CLANDRO_PKG_VERSION#*-p}
	...
	for PATCH_NUM in $(seq -f '%02g' ${_PATCH_VERSION}); do
		PATCHFILE=$CLANDRO_PKG_CACHEDIR/mpfr-${_MAIN_VERSION}-patch${PATCH_NUM}.patch
		clandro_download \

CLANDRO_PKG_HOMEPAGE=https://ptitseb.github.io/box86/
CLANDRO_PKG_DESCRIPTION="Linux Userspace x86 Emulator"
CLANDRO_PKG_LICENSE="MIT"
CLANDRO_PKG_MAINTAINER="@clandro"
_COMMIT=ed3296978ebeee19009b7bd78ea6219cf9996611
_COMMIT_DATE=20230402
_COMMIT_TIME=164444
CLANDRO_PKG_VERSION="0.3.0.20230402.164444ged329697"
CLANDRO_PKG_SRCURL=git+https://github.com/ptitSeb/box86
CLANDRO_PKG_GIT_BRANCH=master
CLANDRO_PKG_DEPENDS="libandroid-complex-math, libandroid-glob, libandroid-spawn, libandroid-sysv-semaphore"
CLANDRO_PKG_AUTO_UPDATE=true

# box86 is for arm only
CLANDRO_PKG_EXCLUDED_ARCHES="aarch64, i686, x86_64"
...
clandro_step_make_install() {
	install -Dm755 -t "${CLANDRO_PREFIX}/bin" "${CLANDRO_PKG_BUILDDIR}/box86"
}

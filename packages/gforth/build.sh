CLANDRO_PKG_HOMEPAGE=https://www.gnu.org/software/gforth/
CLANDRO_PKG_DESCRIPTION="The Forth implementation of the GNU project"
CLANDRO_PKG_LICENSE="GPL-3.0"
CLANDRO_PKG_MAINTAINER="@clandro"
CLANDRO_PKG_VERSION=0.7.3
CLANDRO_PKG_REVISION=3
CLANDRO_PKG_SRCURL=https://mirrors.kernel.org/gnu/gforth/gforth-${CLANDRO_PKG_VERSION}.tar.gz
CLANDRO_PKG_SHA256=2f62f2233bf022c23d01c920b1556aa13eab168e3236b13352ac5e9f18542bb0
...
clandro_step_host_build() {
	...
	./configure --prefix=$_PREFIX_FOR_BUILD CC="gcc -m$CLANDRO_ARCH_BITS"
...
clandro_step_post_configure() {
	sed -i -e 's:\.\(/gforth-ditc\):'$CLANDRO_PKG_HOSTBUILD_DIR'\1:g' \
		Makefile
}

CLANDRO_SUBPKG_DESCRIPTION="Swift runtime libraries for Android AArch64"
CLANDRO_SUBPKG_INCLUDE="opt/ndk-multilib/aarch64-linux-android/lib/lib[_FTXs]*.so"
...
clandro_step_create_subpkg_debscripts() {
	...
	sed 's|@COMMAND@|ln -sf "'$CLANDRO_PREFIX'/opt/ndk-multilib/aarch64-linux-android/lib/lib$so.so" "$install_path"|' \

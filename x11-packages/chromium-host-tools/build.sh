...
CLANDRO_PKG_DESCRIPTION="Chromium web browser (Host tools)"
...
CLANDRO_PKG_BUILD_DEPENDS="libffi-static"
...
clandro_step_post_get_source() {
	...
	local f
	for f in $(find "$CLANDRO_PKG_BUILDER_DIR/cxx-patches" -maxdepth 1 -type f -name *.patch | sort); do
...
EOF
	...
	ln -s /usr/bin/pkg-config "$CLANDRO_PKG_CACHEDIR"/host-pkg-config-bin/pkg-config
...
clandro_step_make_install() {
	...
	mkdir -p "$CLANDRO_PREFIX/opt/$CLANDRO_PKG_NAME/obj/third_party/pdfium/"
	cp "out/Release/obj/third_party/pdfium/libpdfium.a" "$CLANDRO_PREFIX/opt/$CLANDRO_PKG_NAME/obj/third_party/pdfium/"
}

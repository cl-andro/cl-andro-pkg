CLANDRO_PKG_HOMEPAGE=https://github.com/tesseract-ocr/tesseract
CLANDRO_PKG_DESCRIPTION="Tesseract is probably the most accurate open source OCR engine available"
CLANDRO_PKG_LICENSE="Apache-2.0"
CLANDRO_PKG_MAINTAINER="@clandro"
CLANDRO_PKG_VERSION="5.5.2"
CLANDRO_PKG_SRCURL=https://github.com/tesseract-ocr/tesseract/archive/refs/tags/${CLANDRO_PKG_VERSION}.tar.gz
CLANDRO_PKG_SHA256=6235ea0dae45ea137f59c09320406f5888383741924d98855bd2ce0d16b54f21
CLANDRO_PKG_AUTO_UPDATE=true
CLANDRO_PKG_DEPENDS="fontconfig, glib, harfbuzz, leptonica, libandroid-glob, libandroid-posix-semaphore, libarchive, libc++, libcairo, libcurl, libicu, pango"
CLANDRO_PKG_BUILD_DEPENDS="libcpufeatures"
CLANDRO_PKG_BREAKS="tesseract-dev"
CLANDRO_PKG_REPLACES="tesseract-dev"
CLANDRO_PKG_FORCE_CMAKE=true
CLANDRO_PKG_EXTRA_CONFIGURE_ARGS="
-DBUILD_SHARED_LIBS=ON
-DUSE_SYSTEM_ICU=on
-DTESSDATA_PREFIX=$CLANDRO_PREFIX/share
-DOPENMP_BUILD=ON
-DLEPT_TIFF_RESULT=0
"
...
clandro_step_post_make_install() {
	...
	mkdir -p "${CLANDRO_PREFIX}"/share/tessdata
	cd "${CLANDRO_PREFIX}"/share/tessdata
	rm -f eng.*

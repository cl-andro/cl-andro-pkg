CLANDRO_SUBPKG_DESCRIPTION="Utilities for (un)mounting filesystems"
CLANDRO_SUBPKG_DEPENDS="libblkid, libsmartcols, libmount"
CLANDRO_SUBPKG_DEPEND_ON_PARENT=false
CLANDRO_SUBPKG_BREAKS="clandro-tools (<= 1.34.1)"

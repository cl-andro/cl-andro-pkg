...
CLANDRO_PKG_DESCRIPTION="A library of general-purpose, non-graphical Objective C objects"
CLANDRO_PKG_LICENSE="GPL-2.0, LGPL-2.1"
CLANDRO_PKG_MAINTAINER="@clandro"
CLANDRO_PKG_VERSION="1.31.1"
CLANDRO_PKG_REVISION=4
CLANDRO_PKG_SRCURL="https://github.com/gnustep/libs-base/releases/download/base-${CLANDRO_PKG_VERSION//./_}/gnustep-base-${CLANDRO_PKG_VERSION}.tar.gz"
CLANDRO_PKG_SHA256=e7546f1c978a7c75b676953a360194a61e921cb45a4804497b4f346a460545cd
CLANDRO_PKG_AUTO_UPDATE=true
CLANDRO_PKG_DEPENDS="gnustep-make, libcurl, libc++, libffi, libgmp, libgnutls, libiconv, libicu, libxml2, libxslt, zlib"
CLANDRO_PKG_BUILD_IN_SRC=true
CLANDRO_PKG_EXTRA_CONFIGURE_ARGS="
--with-default-config=$CLANDRO_PREFIX/etc/GNUstep/GNUstep.conf
--enable-procfs

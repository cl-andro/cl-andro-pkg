CLANDRO_PKG_HOMEPAGE=https://github.com/cl-andro/clandro-apt-repo
CLANDRO_PKG_DESCRIPTION="Script to create Termux apt repositories"
CLANDRO_PKG_LICENSE="Apache-2.0"
CLANDRO_PKG_MAINTAINER="@clandro"
CLANDRO_PKG_VERSION="0.5"
CLANDRO_PKG_REVISION=4
CLANDRO_PKG_SRCURL="https://github.com/cl-andro/clandro-apt-repo/archive/refs/tags/v${CLANDRO_PKG_VERSION}.tar.gz"

...
#
# Using /data/data/com.zk.clandro/files/usr to substitute full path at build time.
...
LD_PRELOAD="$LD_PRELOAD:@CLANDRO_PREFIX@/lib/libluajit.so" exec "@CLANDRO_PREFIX@/libexec/nvim/nvim" "$@"

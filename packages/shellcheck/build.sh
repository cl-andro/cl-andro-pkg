CLANDRO_PKG_HOMEPAGE="https://www.shellcheck.net/"
CLANDRO_PKG_DESCRIPTION="Shell script analysis tool"
CLANDRO_PKG_LICENSE="GPL-3.0"
CLANDRO_PKG_MAINTAINER="Joshua Kahn <tom@termux.dev> & @clandro"
CLANDRO_PKG_VERSION=0.11.0
CLANDRO_PKG_SRCURL="https://hackage.haskell.org/package/ShellCheck-${CLANDRO_PKG_VERSION}/ShellCheck-${CLANDRO_PKG_VERSION}.tar.gz"
CLANDRO_PKG_SHA256=81a72e9c195788301f38e4b2e250ab916cf3778993d428786bfb2fac2a847400
CLANDRO_PKG_BUILD_IN_SRC=true
CLANDRO_PKG_DEPENDS="libffi, libgmp, libiconv"

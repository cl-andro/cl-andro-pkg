CLANDRO_PKG_HOMEPAGE=https://librewolf.net/
CLANDRO_PKG_DESCRIPTION="A custom version of Firefox, focused on privacy, security and freedom."
CLANDRO_PKG_LICENSE="MPL-2.0"
CLANDRO_PKG_MAINTAINER="@3ls-it"
CLANDRO_PKG_VERSION="150.0.2-1"
CLANDRO_PKG_SRCURL="https://codeberg.org/api/packages/librewolf/generic/librewolf-source/${CLANDRO_PKG_VERSION}/librewolf-${CLANDRO_PKG_VERSION}.source.tar.gz"
CLANDRO_PKG_SHA256=9483d41b4a1efdf00919dce60db4be9d1e05c378839f1c47f48660175c521f22
...
clandro_step_make_install() {
	...
	install -Dm644 -t "${CLANDRO_PREFIX}/share/applications" "${CLANDRO_PKG_BUILDER_DIR}/librewolf.desktop"
...
clandro_step_post_make_install() {
	...
	local r=$("${READELF}" -d "${CLANDRO_PREFIX}/bin/librewolf")

CLANDRO_PKG_HOMEPAGE=https://www.mozilla.org/firefox
CLANDRO_PKG_DESCRIPTION="Mozilla Firefox web browser"
CLANDRO_PKG_LICENSE="MPL-2.0"
CLANDRO_PKG_MAINTAINER="@clandro"
CLANDRO_PKG_VERSION="150.0.2"
CLANDRO_PKG_SRCURL="https://archive.mozilla.org/pub/firefox/releases/${CLANDRO_PKG_VERSION#*really}/source/firefox-${CLANDRO_PKG_VERSION#*really}.source.tar.xz"
CLANDRO_PKG_SHA256=e3830b20cdf660a9cdec6e4d2326d7ced07333d9746df028cfc00c8216acbec9
...
clandro_step_make_install() {
	...
	install -Dm644 -t "${CLANDRO_PREFIX}/share/applications" "${CLANDRO_PKG_BUILDER_DIR}/firefox.desktop"
...
clandro_step_post_make_install() {
	...
	local r=$("${READELF}" -d "${CLANDRO_PREFIX}/bin/firefox")
